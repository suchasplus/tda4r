// Generated from C:/dev/IdeaProjects/parser/src/main/resources\LibExpr.g4 by ANTLR 4.7
package com.suchasplus.gen.libexpr;
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__5) | (1L << ID) | (1L << INT) | (1L << NL))) != 0) );
			}
		}
